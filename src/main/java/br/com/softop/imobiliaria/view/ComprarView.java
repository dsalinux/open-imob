...
@SessionScoped
@ManagedBean
public class ComprarView extends JSFUtil {
    ...
    public ComprarView() {
        ...
        imovelVO.setTipo_(Imovel.Tipo.VENDA);
    }
    ...
    public void init() {
        try {
            ...
            Logger.getLogger(ComprarView.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
    ...
    public void buscar() {
        if (Context.getImovelConsulta() != null) {
            ...
            if (Imovel.Tipo.VENDA.equals(i.getTipo_())) {
                imovelVO = i;
            }
